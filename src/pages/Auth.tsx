...
import { Eye, EyeOff, Loader2, Store, Globe } from "lucide-react";
import { z } from "zod";
import {
  DropdownMenu,
  DropdownMenuContent,
...
const Auth = () => {
  ...
  return (
    <div className="min-h-screen flex">
      ...
      {/* Right side - Form */}
      <div className="w-full lg:w-1/2 flex items-center justify-center bg-background p-4 sm:p-8 relative">
          ...
          <Card className="border-0 shadow-xl lg:shadow-none lg:border">
            <CardHeader className="space-y-1 pb-4">
              ...
              <CardDescription className="text-center">
                {activeTab === "login" ? t('loginDesc') : t('signupDesc')}
              </CardDescription>
            </CardHeader>
            <CardContent>
